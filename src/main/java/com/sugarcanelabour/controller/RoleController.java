...
public class RoleController {
	...
	@PostMapping("/add")
	public ResponseEntity<ApiResponse<String>> addRole(@RequestBody Role role) {
		if (log.isInfoEnabled()) {
			log.info("***** Inside RoleController - addRole *****");
		}
	...
	@Operation(summary = "Get Role by ID API", description = "This API is used to retrieve a role by Role ID")
	@GetMapping("/get/{id}")
