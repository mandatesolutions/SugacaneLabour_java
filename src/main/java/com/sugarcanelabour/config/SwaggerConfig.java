...
//
	...
	private Info info() {
		return new Info().title("SugarCane Labor").description(swaggerDesc).version("1.0.0")
				.contact(new Contact().name("Vaishnavi Bakal").email("mailId").url(webSiteUrl));
	}

//	private ApiInfo apiEndPointsInfo() {
//		return new ApiInfoBuilder().title("LB PASSIVE FIRE APP REST API")
//				 .description("LB PASSIVE FIRE APP REST API")
//				 .contact(new Contact("Dheeraj Sutar", "www.wargstech.com", "dheeraj.sutar@wargstech.com"))
//		            .license("Apache 2.0")
